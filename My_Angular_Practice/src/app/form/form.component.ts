  ...
  form! : FormGroup;
   ...
   ngOnInit(){
    ...
    save(){
     ...
     this.commonApiCallService.postApiCall(urlEndPoint,formData).subscribe((resp: any)=>{
      console.log(resp);
     })
    }
    ...
    getData(){
      ...
      this.commonApiCallService.getApiCall(endpointToGetData).subscribe((data: any) =>{
